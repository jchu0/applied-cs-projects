...
> **Concepts covered:** [§03 PyTorch + CUDA (multi-GPU)](../../03-machine-learning-engineering/06-cuda-optimization/pytorch-cuda/pytorch-cuda.md) · [§05 Cost optimization](../../05-cross-cutting-concerns/cost-optimization/) · [§07 Kubernetes](../../07-infrastructure/kubernetes/kubernetes-guide.md) (the orchestration analog this project competes with). Pairs with [Project 48 (multi-GPU kernel scheduler — the per-job kernel side)](../48-multi-gpu-kernel-scheduler/) and [Project 04 (training orchestrator)](../04-ml-training-orchestrator/). Map: [`CONCEPT_TO_PROJECT_MAP.md`](../CONCEPT_TO_PROJECT_MAP.md).
